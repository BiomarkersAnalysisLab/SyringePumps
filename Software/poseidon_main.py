...
class MainWindow(QtWidgets.QMainWindow, poseidon_controller_gui.Ui_MainWindow):
	...
	def populate_syringe_sizes(self):
		...
		self.syringe_areas = [17.34206347, 57.88559215, 112.9089185, 163.539454, 318.411386, 366.0961536, 554.0462538]
...
def main():
	...
	window = MainWindow()
	window.setWindowTitle("Poseidon Pumps Controller - Biomarkers Analysis Lab AGH 2024")
	window.show()
